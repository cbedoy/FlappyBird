...
public class ac
{
    ...
    private ac(Context context, ViewGroup viewgroup, af af1)
    {
        c = -1;
        if (viewgroup == null)
        {
        ...
        } else
        {
            ...
            o = (int)(0.5F + 20F * context.getResources().getDisplayMetrics().density);
    ...
    private int a(int i1, int j1, int k1)
    {
        ...
        float f2 = (float)i2 + (float)i2 * b(f1);
        int j2 = Math.abs(j1);
        int k2;
        if (j2 > 0)
        {
    ...
    public static ac a(ViewGroup viewgroup, float f1, af af1)
    {
        ac ac1 = a(viewgroup, af1);
        ac1.b = (int)((float)ac1.b * (1.0F / f1));
        return ac1;
    }

    public static ac a(ViewGroup viewgroup, af af1)
    {
        return new ac(viewgroup.getContext(), viewgroup, af1);
    }
...
_L6:
    ...
    public boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)ao.a(l, c), (int)ao.b(l, c));
        }
    }
...
_L5:
        ...
        float f5 = z.c(motionevent, j1);
        float f6 = z.d(motionevent, j1);
        a(f5, f6, j2);
        if (a == 0)
        {
            int k2 = h[j2];
...
_L8:
        i2 = z.b(motionevent, l1);
        f1 = z.c(motionevent, l1);
        f2 = z.d(motionevent, l1);
        f3 = f1 - d[i2];
        f4 = f2 - e[i2];
        b(f3, f4, i2);
...
_L6:
        ...
        float f10;
        int j4;
        i4 = z.b(motionevent, k1);
        f9 = z.c(motionevent, k1);
        f10 = z.d(motionevent, k1);
        a(f9, f10, i4);
        if (a != 0)
        {
...
_L4:
        ...
        if (a == 1)
        {
            ...
            float f7 = z.c(motionevent, j3);
            float f8 = z.d(motionevent, j3);
            int k3 = (int)(f7 - f[c]);
            int l3 = (int)(f8 - g[c]);
...
_L10:
        ...
        float f5;
        float f6;
        i3 = z.b(motionevent, i1);
        f3 = z.c(motionevent, i1);
