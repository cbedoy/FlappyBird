...
public class FragmentActivity extends Activity
{
    ...
    final o b = new o();
    final android.support.v4.app.l c = new i(this);
    boolean d;
    boolean e;
    boolean f;
    boolean g;
...
_L3:
    ...
    z a(String s, boolean flag, boolean flag1)
    {
        if (l == null)
        {
            l = new l();
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        k k1 = (k)getLastNonConfigurationInstance();
        if (k1 != null)
        {
            l = k1.e;
        }
    ...
    public View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        TypedArray typedarray = context.obtainStyledAttributes(attributeset, j.a);
        if (s1 == null)
        {
