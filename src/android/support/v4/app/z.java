...
class z extends x
{
    ...
    z(String s, FragmentActivity fragmentactivity, boolean flag)
    {
        d = s;
        e = fragmentactivity;
        f = flag;
    ...
    public void a(String s, FileDescriptor filedescriptor, PrintWriter printwriter, String as[])
    {
        ...
        if (b.b() > 0)
        {
            ...
            for (int j = 0; j < b.b(); j++)
            {
                ...
                printwriter.print(": ");
                printwriter.println(aa2.toString());
                aa2.a(s2, filedescriptor, printwriter, as);
            }
        ...
        if (c.b() > 0)
        {
            ...
            for (; i < c.b(); i++)
            {
                ...
                printwriter.print(": ");
                printwriter.println(aa1.toString());
                aa1.a(s1, filedescriptor, printwriter, as);
            }
