...
//            m, p, FragmentActivity, Fragment, 
//            b, z, FragmentManagerState, FragmentState, 
//            BackStackState, ac, ab, l, 
//            q, n, w
...
_L4:
        ...
        if (!fragment.F)
        {
            throw new ac((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onAttach()").toString());
        }
        if (fragment.v == null)
        {
            o.a(fragment);
...
_L11:
        if (i1 < 1)
        {
            ...
            } else
            {
                ...
                if (!fragment.F)
                {
                    throw new ac((new StringBuilder()).append("Fragment ").append(fragment).append(" did not call through to super.onDetach()").toString());
                }
                if (!flag)
                {
                    if (!fragment.C)
        ...
        if (i1 < 2)
        {
            ...
            if (fragment.I != null && fragment.H != null)
            {
                ...
                if (animation != null)
                {
                    ...
                    fragment.c = i1;
                    animation.setAnimationListener(new q(this, fragment));
