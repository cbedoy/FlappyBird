...
public final class f
{
    ...
    abyte0
        ...
        if (packageinfo1.versionCode < 0x31d24c)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder()).append("Google Play services out of date.  Requires 3265100 but found ").append(packageinfo1.versionCode).toString());
            return 2;
        }
    ...
    public static Dialog a(int i1, Activity activity, int j1, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        return a(i1, activity, j1, oncancellistener, -1);
    }

    public static Dialog a(int i1, Activity activity, int j1, android.content.DialogInterface.OnCancelListener oncancellistener, int k1)
    {
        android.app.AlertDialog.Builder builder = (new android.app.AlertDialog.Builder(activity)).setMessage(b(activity, i1, k1));
        if (oncancellistener != null)
        {
            builder.setOnCancelListener(oncancellistener);
        }
        cp cp1 = new cp(activity, a(((Context) (activity)), i1, k1), j1);
        String s = a(((Context) (activity)), i1);
        if (s != null)
        {
            builder.setPositiveButton(s, cp1);
        }
        switch (i1)
        {
        default:
            Log.e("GooglePlayServicesUtil", (new StringBuilder()).append("Unexpected error code ").append(i1).toString());
            return builder.setTitle(d.common_google_play_services_unknown_issue).create();
...
label0:
    ...
    //                   8 56
    //                   9 174;
           goto _L1 _L2 _L3 _L4 _L1 _L5 _L1 _L6 _L1 _L7
_L1:
        String s = resources.getString(d.common_google_play_services_unknown_issue);
_L9:
        return s;
_L2:
        if (a(context.getResources()))
        {
            s = resources.getString(d.common_google_play_services_install_text_tablet);
        } else
        {
            s = resources.getString(d.common_google_play_services_install_text_phone);
        }
        if (!a(j1)) goto _L9; else goto _L8
_L8:
        return (new StringBuilder()).append(s).append(" (via Bazaar)").toString();
_L4:
        return resources.getString(d.common_google_play_services_enable_text);
_L3:
        s = resources.getString(d.common_google_play_services_update_text);
        if (!a(j1)) goto _L9; else goto _L10
_L10:
        return (new StringBuilder()).append(s).append(" (via Bazaar)").toString();
_L7:
...
_L5:
    ...
    private static boolean b(Resources resources)
    {
        ...
        if (flag)
        {
            int i1 = 0xf & configuration.screenLayout;
            flag1 = false;
            if (i1 <= 3)
            {
                int j1 = configuration.smallestScreenWidthDp;
                flag1 = false;
                if (j1 >= 600)
                {
                    flag1 = true;
    ...
    private static boolean c(Context context)
    {
        ...
        } else
        {
            ...
            try
            {
                abyte0 = a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), e);
            }
            catch (android.content.pm.PackageManager.NameNotFoundException namenotfoundexception)
            {
                return false;
